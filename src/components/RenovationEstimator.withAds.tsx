...
export default function RenovationEstimator() {
  ...
  const estimateCosts = () => {
    ...
    if (formData.type === 'Kitchen') {
      // Use user-provided linear feet or calculate default
      const cabinetLength = formData.cabinetLinearFeet 
        ? Number(formData.cabinetLinearFeet)
        : Math.sqrt(size) * 2; // Default calculation if not provided
          ...
          <div className="w-80 flex-shrink-0">
            <div className="sticky top-8">
              ...
              <div className="bg-gray-800 rounded-xl p-4 mb-6">
                <div className="aspect-[4/5] bg-gray-700 rounded-lg flex items-center justify-center">
